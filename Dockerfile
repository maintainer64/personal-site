...
COPY . /src
RUN mkdir -p /src/themes/hello-friend-ng && git clone --depth=1 --branch=1.0.6 https://github.com/rhazdon/hugo-theme-hello-friend-ng.git /src/themes/hello-friend-ng
RUN hugo --minify
